...
import { MenuIcon, SearchIcon, TicketCheck , XIcon } from "lucide-react";
...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full z-0 left-0 flex items-center justify-between px-6 md:px-16 lg:px-36 py-5 ">
      <Link to={"/"}>
